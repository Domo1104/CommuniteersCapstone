  ...
  if (category === "community") {
    ...
    return (
      ...
      >
        ...
        <option value="Endangered Species Conservation">
        ...
        <option value="Wildlife Law Enforcement Officer">
          Wildlife Law Enforcement Officer
        </option>
        <option value="Wildlife Inspector and Forensics Specialist">
    ...
    return (
      ...
      >
        ...
        <option value="Assisting Wildlife Education Officers">
          Assisting wildlife education officers
        </option>
